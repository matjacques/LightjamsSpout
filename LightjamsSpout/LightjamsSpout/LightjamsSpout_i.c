...
MIDL_DEFINE_GUID(IID, IID_IGLContext,0x67C962BF,0x9418,0x4E34,0xAC,0x62,0xC1,0x5C,0xF8,0xF8,0x38,0x8F);
...
MIDL_DEFINE_GUID(CLSID, CLSID_GLContext,0xA613DC0B,0xB1D6,0x41C8,0xB7,0x14,0x4B,0xD7,0x11,0x65,0x60,0xEB);
